...
final class Version20221011141731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE draw (id UUID NOT NULL, winner_id UUID DEFAULT NULL, tickets_quantity INT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, launched_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_done BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ticket (id UUID NOT NULL, draw_id UUID DEFAULT NULL, wallet_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_97A0ADA36FC5C1B8 ON ticket (draw_id)');
        $this->addSql('CREATE INDEX IDX_97A0ADA3712520F3 ON ticket (wallet_id)');
        $this->addSql('COMMENT ON COLUMN ticket.id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN ticket.draw_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN ticket.wallet_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN ticket.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE wallet (id UUID NOT NULL, address VARCHAR(128) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE draw ADD CONSTRAINT FK_70F2BD0F5DFCD4B8 FOREIGN KEY (winner_id) REFERENCES ticket (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
