 ...
 */
final class Version20221020183407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE draw (id UUID NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, launched_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, done_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_done BOOLEAN NOT NULL, winner VARCHAR(255) DEFAULT NULL, award BIGINT DEFAULT NULL, PRIMARY KEY(id))');
